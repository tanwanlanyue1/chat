...
//发布邀约-成功
class ReleaseSuccess extends StatelessWidget {
  const ReleaseSuccess({super.key});
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Text(S.current.ifUserAttends,style: AppTextStyle.fs14b.copyWith(color: Colors.white),),
                const Spacer(),
                GestureDetector(
                  onTap: (){
                    Get.back();
