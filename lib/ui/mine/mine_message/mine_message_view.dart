...
///我的-消息列表
class MineMessageView extends StatefulWidget {
  ///0系统消息，6系统公告
  final int type;
  ...
  @override
  State<MineMessageView> createState() => _MineMessageViewState();
}

class _MineMessageViewState extends State<MineMessageView> with AutomaticKeepAliveClientMixin {
  @override
  Widget build(BuildContext context) {
    super.build(context);
    return GetBuilder(
      init: MineMessageController(type: widget.type),
      global: false,
      builder: (controller) {
        return SmartRefresher(
          ...
          child: PagedListView.separated(
            padding: FEdgeInsets(horizontal: 16.rpx, vertical: 16.rpx),
