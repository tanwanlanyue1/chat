...
class VideoEditorPage extends StatefulWidget {
  ...
  const VideoEditorPage._({super.key, required this.item});

  static Future<VideoItem?> open(VideoItem item) async{
    return Get.to<VideoItem>(() => VideoEditorPage._(item: item));
  }
